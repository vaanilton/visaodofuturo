...
/* @var $searchModel backend\models\AnuncioSearch */
...
<div class="anuncio-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-font"></i> Anuncio</h3>',
            'type'=>'success',
            'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> Novo Anuncio', ['create'], ['class' => 'btn btn-success']),
