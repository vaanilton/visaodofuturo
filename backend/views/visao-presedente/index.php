...
<div class="visao-presedente-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-font"></i> Visão Do Presidente</h3>',
            'type'=>'success',
            'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> Novo Visão Do Presidente', ['create'], ['class' => 'btn btn-success']),
