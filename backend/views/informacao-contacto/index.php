...
<div class="informacao-contacto-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-font"></i> Informação de Contacto</h3>',
            'type'=>'success',
            'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> Novo Contacto', ['create'], ['class' => 'btn btn-success']),
