...
<div class="fornecedor-index">
    ...
    <div class="col-md-3">
      <p>
          <?= Html::a('Cadastrar Pastor', ['pastor'], ['class' => 'btn btn-success']) ?>
      </p>
    </div>
      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
          <div class="input-group">
            <input type="text" class="form-control" placeholder="Pesquisar Pastor...">
              ...
              <div class="col-md-55">
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    <p>
                      <strong>
                        <?php echo $agricultor['nome'] ?>
                      </strong>
                    </p>
                    <p>
                      <strong>
                        BI: <?php echo $agricultor['bi'] ?>
                      </strong>
                    </p>
                  </div>
                </div>
