...
/* @var $searchModel backend\models\FaturaSearch */
...
<div class="fatura-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            //'id_cliente',
            [
                  'attribute'=>'Nome Cliente',
                  'value'=>'cliente.nome',
                  'pageSummary' => 'Total',
            ],
            //'id_utilizador',
            [
                  'attribute'=>'Nome Vendedor',
                  'value'=>'utilizador.nome'
            ],
            'numero_fatura',
            //'total_venda',
            [
                  'attribute'=>'Total Vendido',
                  'value'=>'total_venda',
                  'pageSummary' => true,
            ],
        ...
        'panel' => [
            'heading'=>'<h3 class="panel-title"><i class="fa fa-list-alt"></i> Faturas</h3>',
            'type'=>'success',
            'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> Novo Factura', ['create'], ['class' => 'btn btn-success']),
