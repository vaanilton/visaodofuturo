...
/* @var $searchModel backend\models\AreaEspecialisacaoSearch */
...
<div class="area-especialisacao-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-font"></i> Area de Especialisação</h3>',
            'type'=>'success',
            'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> Novo Area de Especialisação', ['create'], ['class' => 'btn btn-success']),
