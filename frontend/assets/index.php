 		...
 		<div class="modal-dialog">
             ...
             <?php if($modelsVisaoPresedente){
               foreach ($modelsVisaoPresedente as $key => $value) {
                 ...
                 <p>
                   <img src="<?php echo Yii::getAlias('@web').'/'.$value['photo']?>" width='200px' height="200px" style="float:left;margin-right: 10px" alt="" />
                 <?php
                    echo $dados;
                  ?>
                </p>
      ...
      <div class="modal_body_left modal_body_left1" style="background-color: #E9EBEE;padding: 18px;font-size: 16px;
         ...
         <?php if($modelsVisaoPresedente){
           foreach ($modelsVisaoPresedente as $key => $value) {
             ...
             <p>
               <img src="<?php echo Yii::getAlias('@web').'/'.$value['photo']?>" width='300px' height="300px" style="float:left;margin-right: 10px" alt="" />
             <?php
                echo $dados;
              ?>
            </p>
            ...
            foreach ($modelsUsers as $key => $users) { ?>
            	<div class="col-sm-3 col-xs-6">
                  ...
                  <?php if(file_exists($users['photo'])) { ?>
                    ...
                    <img src="<?php echo Yii::getAlias('@web').'/'.$users['photo'] ?>" width="50px" height="350px" alt="">
              ...
              ?>
  							<li>
  								<div class="inner-testimonials-lifels">
  									<img src="<?php echo Yii::getAlias('@web').'/'.$fornecedor['photo']?>" width="500px" height="500px" alt=""/>
