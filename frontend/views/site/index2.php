...
<div class="main-nature">
		...
		<div class="nature-top">
          ...
          <a href="#Especialisamos" class="scroll">Especialização</a>
  ...
  <div class="modal fade" id="anuncio" tabindex="-1" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body modal-body-sub_nature">
          ...
          <div class="modal_body_left modal_body_left1">
            ...
            <?php if($modelsAnuncio){
              foreach ($modelsAnuncio as $key => $value) {
              $pegar = shortdata($value['descricao'], $len=2000);
            ?>
            ...
            <h4 style="background-color: #E9EBEE;padding: 18px;text-align: center;font-size: 16px;
                ...
                Promoção de auto emprego de forma sustentável e duradouro
            </h4>
            ...
            <h3 class="tittle">
             ...
             <h3 class="tittle">
              ...
              font-family: Open Sans; letter-spacing:2px; vertical-align: baseline; line-height: 32px; font-style: negrito">
              <?php
                 echo $value['requisitos'] ;
              ?>
              </h4>

              <a href="" data-toggle="modal" data-target="#inscrever" class="life-buttons">Inscrever</a>
  ...
  <div class="modal fade" id="inscrever" tabindex="-1" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
